...
def main() -> int:
    ...
    run_case(
        binary,
        "one-event remote decode coalescing",
        clean(
            """
            1 1.000000000 2.000000000 1.000000000 100 1
    ...
    run_case(
        binary,
        "lookahead chooses the first independent decode cohort",
        clean(
            """
            1 1.000000000 2.000000000 1.000000000 100 1
            30.000000000 15.000000000 1.000000000 0.000000000 0.000000000 0.500000000 0.500000000
    ...
    # Keep every queued prefill overdue so this fixture isolates placement and
    # preserves its arrival-order transcript rather than exercising SJF.
    run_case(
        binary,
        ...
        clean(
            ...
            0.500000000 1000.000000000 1.000000000 0.000000000 0.000000000 0.500000000 0.500000000
            2
    ...
    run_case(
        binary,
        "cold decode does not split contended prefill",
        clean(
            """
    ...
    run_case(
        binary,
        "prefill precedes overdue first-token decode",
        clean(
            """
            1 1.000000000 1.000000000 100.000000000 100 1
            1000.000000000 0.001000000 1.000000000 0.000000000 0.000000000 0.000000000 1.000000000
            1
            1 1.000000000 1.000000000 1.000000000 1.000000000 1.000000000 1.000000000
            0.000000000
            1
    ...
    run_case(
        binary,
        "active decode precedes prefill",
        clean(
            """
            1 1.000000000 1.000000000 100.000000000 100 1
            1000.000000000 1000.000000000 1.000000000 0.000000000 0.000000000 0.000000000 1.000000000
            1
            1 1.000000000 1.000000000 1.000000000 1.000000000 1.000000000 1.000000000
            0.000000000
            1
    ...
    run_case(
        binary,
        "latency-only admission ignores first-token decode",
        clean(
            """
            1 1.000000000 1.000000000 100.000000000 1000000 1
            1.000000000 10.000000000 1.000000000 0.000000000 0.000000000 0.000000000 1.000000000
            2
            1 1.000000000 1.000000000 1.000000000 1.000000000 1.000000000 1.000000000
